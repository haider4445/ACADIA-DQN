    ...
    if params['sarsa_enable']:
        ...
        for i in range(num_episodes):
            ...
            try:
                ...
                ep_length, ep_reward, actions, action_means, states, kl_certificates, attack_times_perEpisode, successesPerEpisode  = p.run_test(params, compute_bounds=params['compute_kl_cert'], use_full_backward=params['use_full_backward'], original_stdev=None)
...
def get_parser():
    ...
    parser.add_argument('--steps', nargs = "?", default = 50, type = int, help = "Number of steps ")
    ...
    parser.add_argument('-p','--perturbationType', nargs="?", default="airfgm", type = str, help = 'Perturbation Type: fgsm, rfgsm, cw, mrfgsm, pgd, mifgsm, difgsm')
    parser.add_argument('--targeted', nargs = "?", default = 0, type = int, help = "0 or 1")
    parser.add_argument('--totalEpisodes', nargs = "?", default = 10, type = int, help = "total games/episodes")
