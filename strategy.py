...
class Strategy:
	...
	def CriticalPointStrategy(self, M,n,net, state, env_orig, acts_mask = [], repeat_adv_act = 1, dam = "pong", domain = True, delta, fullSearch = False):
        ...
        if domain == True:
	        if dam == "pong":
	        	std_dam = dam_pong(baselineState)
        else:
        	std_dam = reward
